namespace InfiniteConvergetSeries
{
    ...
    public class InfiniteConvergetSeries
    {
        /// series 1/2^n
        ...
        public static void Main()
        {
            ...
            Console.WriteLine("Sum of 1/2^n: {0:0.000}", CalculateSeries.Calculate(NextMemberPowerOfTwo, Error));
            Console.WriteLine("Sum of 1/n!: {0:0.000}", CalculateSeries.Calculate(FactorialSeriesNextMember, FactorialError));
            Console.WriteLine("Sum of 1 + 1/(-2)^(n+1): {0:0.000}", CalculateSeries.Calculate(AlternativeSeriesNextMember, AlternativeSeriesError));
        }
    }
}
